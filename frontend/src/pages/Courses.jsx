...
export default function Courses() {
  ...
  async function addCourse() {
      try {
        ...
        toast.error(getApiErrorMessage(e, "Kursni saqlab bo'lmadi."));
      }
  }
  ...
  async function updateCourse() {
      try {
        ...
        toast.error(getApiErrorMessage(e, "Kursni yangilab bo'lmadi."));
      }
  }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(e, "Kursni arxivga yuborib bo'lmadi."));
    }
  };
  ...
  async function restoreCourse(id) {
    try {
      ...
      toast.error(getApiErrorMessage(e, "Kursni arxivdan qaytarib bo'lmadi."));
    }
  }
