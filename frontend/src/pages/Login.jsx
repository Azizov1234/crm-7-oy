...
export default function Login() {
  ...
  const [login, setLogin] = useState('+998900000001');
  ...
  const leftBackgroundImage =
    'url("/images/login.webp"), url("/images/login.svg"), url("/images/login.png"), url("/images/login.jpg")';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      const msg = err?.response?.data?.message || err?.userMessage || err.message;
      ...
      <Box
        sx={{
          ...
          '&::before': {
            ...
            inset: 0,
            background:
              'linear-gradient(180deg, rgba(8,12,20,0.42) 0%, rgba(8,12,20,0.58) 100%)',
            zIndex: 1,
          },
        }}
      />
