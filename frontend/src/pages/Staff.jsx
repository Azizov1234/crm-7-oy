...
export default function Staff() {
  ...
  async function saveStaff() {
    try {
      ...
      toast.error(getApiErrorMessage(err, "Xodimni saqlab bo'lmadi."));
    }
  }
  ...
  async function updateStaff() {
    try {
      ...
      toast.error(getApiErrorMessage(err, "Xodimni yangilab bo'lmadi."));
    }
  }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(err, "Xodimni arxivga yuborib bo'lmadi."));
    }
  };
  ...
  async function restoreStaff(id) {
    try {
      ...
      toast.error(getApiErrorMessage(err, "Xodimni arxivdan chiqarib bo'lmadi."));
    }
  }
        ...
        <Box sx={{ p: 3, overflowY: 'auto', flex: 1 }}>
          <Stack spacing={2.5}>
            ...
            <Box>
              ...
              <TextField fullWidth size="small" type={showPassword ? 'text' : 'password'} placeholder="Kuchli parol kiriting"
