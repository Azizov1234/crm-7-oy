...
export default function Teachers() {
  ...
  async function saveTeacher() {
    try {
      ...
      toast.error(getApiErrorMessage(err, "O'qituvchini saqlab bo'lmadi."));
    }
  }
  ...
  async function updateTeacher() {
    try {
      ...
      toast.error(getApiErrorMessage(err, "O'qituvchini yangilab bo'lmadi."));
    }
  }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(err, "O'qituvchini arxivga yuborib bo'lmadi."));
    }
  };
  ...
  async function restoreTeacher(id) {
    try {
      ...
      toast.error(getApiErrorMessage(err, "O'qituvchini arxivdan chiqarib bo'lmadi."));
    }
  }
                  ...
                  <TableRow key={teacher.id} hover sx={{ '&:last-child td': { border: 0 } }}>
                    ...
                    <TableCell>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                        <Avatar
                          src={teacher.photo ? resolveBackendFileUrl(teacher.photo) : undefined}
        ...
        <Box sx={{ p: 3, overflowY: 'auto', flex: 1 }}>
          <Stack spacing={2.5}>
            ...
            <Box>
              ...
              <TextField fullWidth size="small" type={showPassword ? 'text' : 'password'} placeholder="Parolni kiriting"
