...
export default function Rooms() {
  ...
  async function createRoom() {
    try {
      ...
      toast.error(getApiErrorMessage(e, "Xonani saqlab bo'lmadi."));
    }
  }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(e, "Xonani arxivga yuborib bo'lmadi."));
    }
  };
  ...
  async function restoreRoom(id) {
    try {
      ...
      toast.error(getApiErrorMessage(e, "Xonani arxivdan qaytarib bo'lmadi."));
    }
  }
  ...
  async function updateRoom(id) {
    try {
      ...
      toast.error(getApiErrorMessage(e, "Xonani yangilab bo'lmadi."));
    }
  }
